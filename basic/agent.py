...
# Child gets all base tools except subagent (no recursive spawning)
CHILD_TOOLS = [
...
# -- Parent tools: base tools + subagent dispatcher --
PARENT_TOOLS = CHILD_TOOLS + [
    {"name": "subagent", "description": "Spawn a subagent with fresh context. It shares the filesystem but not conversation history.",
     "input_schema": {"type": "object", "properties": {"prompt": {"type": "string"}, "description": {"type": "string", "description": "Short description of the subagent's task"}}, "required": ["prompt"]}},
]
